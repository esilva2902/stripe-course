...
export function initServer() {
    ...
    // To convert the payload to a javascript object:
    ...
    /**
     * /stripe-webhooks is the route exposed by our Server to be invoked
     * only by Stripe.
     *
     * Since every request must be signed by Stripe an validated in our
     * Server, the request body must be receive as a raw string.
     */
